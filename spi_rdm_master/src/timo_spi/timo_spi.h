...
#define TIMO_RADIO_DISCOVERY 0xA0
#define TIMO_RADIO_DISCOVERY_RESULT 0xA1
#define TIMO_RADIO_MUTE 0xA2
#define TIMO_RADIO_MUTE_RESPONSE 0xA3
#define TIMO_RDM_DISCOVERY 0xA4
#define TIMO_RDM_DISCOVERY_RESULT 0xA5
#define TIMO_NODE_QUERY 0xA6
#define TIMO_NODE_QUERY_RESPONSE 0xA7
...
#define TIMO_REGISTERS                                                         \
    {                                                                          \
        {.address = TIMO_CONFIG_REG,                                           \
         .length = 1,                                                          \
         .read_access = 1,                                                     \
         .write_access = 1,                                                    \
         .name = "CONFIG"},                                                    \
        {.address = TIMO_STATUS_REG,                                           \
         .length = 1,                                                          \
         .read_access = 1,                                                     \
         .write_access = 1,                                                    \
         .name = "STATUS"},                                                    \
        {.address = TIMO_IRQ_MASK_REG,                                         \
         .length = 1,                                                          \
         .read_access = 1,                                                     \
         .write_access = 1,                                                    \
         .name = "IRQ_MASK"},                                                  \
        {.address = TIMO_IRQ_FLAGS_REG,                                        \
         .length = 1,                                                          \
         .read_access = 1,                                                     \
         .write_access = 0,                                                    \
         .name = "IRQ_FLAGS"},                                                 \
        {.address = TIMO_DMX_WINDOW_REG,                                       \
         .length = 4,                                                          \
         .read_access = 1,                                                     \
         .write_access = 1,                                                    \
         .name = "DMX_WINDOW"},                                                \
        {.address = TIMO_ASC_FRAME_REG,                                        \
         .length = 3,                                                          \
         .read_access = 1,                                                     \
         .write_access = 0,                                                    \
         .name = "ASC_FRAME"},                                                 \
        {.address = TIMO_LINK_QUALITY_REG,                                     \
         .length = 1,                                                          \
         .read_access = 1,                                                     \
         .write_access = 0,                                                    \
         .name = "LINK_QUALITY"},                                              \
        {.address = TIMO_ANTENNA_REG,                                          \
         .length = 1,                                                          \
         .read_access = 1,                                                     \
         .write_access = 1,                                                    \
         .name = "ANTENNA"},                                                   \
        {.address = TIMO_DMX_SPEC_REG,                                         \
         .length = 8,                                                          \
         .read_access = 1,                                                     \
         .write_access = 1,                                                    \
         .name = "DMX_SPEC"},                                                  \
        {.address = TIMO_DMX_CONTROL_REG,                                      \
         .length = 1,                                                          \
         .read_access = 1,                                                     \
         .write_access = 1,                                                    \
         .name = "DMX_CONTROL"},                                               \
        {.address = TIMO_VERSION_REG,                                          \
         .length = 8,                                                          \
         .read_access = 1,                                                     \
         .write_access = 0,                                                    \
         .name = "VERSION"},                                                   \
        {.address = TIMO_RF_POWER_REG,                                         \
         .length = 1,                                                          \
         .read_access = 1,                                                     \
         .write_access = 1,                                                    \
         .name = "RF_POWER"},                                                  \
        {.address = TIMO_BLOCKED_CHANNELS_REG,                                 \
         .length = 11,                                                         \
         .read_access = 1,                                                     \
         .write_access = 1,                                                    \
         .name = "BLOCKED_CHANNELS"},                                          \
        {.address = TIMO_BINDING_UID_REG,                                      \
         .length = 6,                                                          \
         .read_access = 1,                                                     \
         .write_access = 1,                                                    \
         .name = "BINDING_UID"},                                               \
        {.address = TIMO_BLE_STATUS_REG,                                       \
         .length = 1,                                                          \
         .read_access = 1,                                                     \
         .write_access = 1,                                                    \
         .name = "BLE_STATUS"},                                                \
        {.address = TIMO_BLE_PIN_REG,                                          \
         .length = 6,                                                          \
         .read_access = 0,                                                     \
         .write_access = 1,                                                    \
         .name = "BLE_PIN"},                                                   \
        {.address = TIMO_BATTERY_REG,                                          \
         .length = 1,                                                          \
         .read_access = 0,                                                     \
         .write_access = 1,                                                    \
         .name = "BATTERY"},                                                   \
        {.address = TIMO_UNIVERSE_COLOR_REG,                                   \
         .length = 3,                                                          \
         .read_access = 1,                                                     \
         .write_access = 1,                                                    \
         .name = "UNIVERSE_COLOR"},                                            \
        {.address = TIMO_OEM_INFO_REG,                                         \
         .length = 6,                                                          \
         .read_access = 1,                                                     \
         .write_access = 1,                                                    \
         .name = "OEM_INFO"},                                                  \
